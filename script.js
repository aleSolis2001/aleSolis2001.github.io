function Calcular() {
    ...
    if (pesoInput.value !== "" && pesoInput.value > 0) {
        ...
        if (peso <= 10) {
            ...
            const mantenimientoMedio = hidratacionBasal * 1.5
        } else if (peso <= 20) {
            ...
            mMedio.innerHTML = "m + m/2: <span class='resaltar'>" + `${(hidratacionBasal1500 / 24 * 1.5).toFixed(1)} - ${(hidratacionBasal2000 / 24 * 1.5).toFixed(1)}` + "</span> cc/hr";
            return;
        }
